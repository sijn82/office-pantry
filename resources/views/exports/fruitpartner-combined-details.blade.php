<table>
    ...
    <thead>
      <tr>
          ...
          @if ($organic_semi_skimmed_2l_total === 0) @else <th>Organic 2l Semi-Skimmed</th> @endif
          @if ($organic_skimmed_2l_total === 0) @else <th>Organic 2l Skimmed</th> @endif
          @if ($organic_whole_2l_total === 0) @else <th>Organic 2l Whole</th> @endif
          @if ($organic_semi_skimmed_1l_total === 0) @else <th>Organic 1l Semi-Skimmed</th> @endif
          @if ($organic_skimmed_1l_total === 0) @else <th>Organic 1l Skimmed</th> @endif
          @if ($organic_whole_1l_total === 0) @else <th>Organic 1l Whole</th> @endif
          ...
          @if ($alt_soya_chocolate_total === 0) @else <th>Milk 1l Alt Soya Chocolate</th> @endif

          @if ($alt_oat_total === 0) @else <th>Milk 1l Alt Oat</th> @endif
          @if ($alt_cashew_total === 0) @else <th>Milk 1l Alt Cashew</th> @endif
          @if ($alt_hazelnut_total === 0) @else <th>Milk 1l Alt Hazelnut</th> @endif
    ...
    <tbody>
        ...
        <tr>
            ...
            @if ($alt_soya_chocolate_total === 0) @elseif ($delivery->milk_1l_alt_soya_chocolate === 0) <td></td> @else <td>{{ $delivery->milk_1l_alt_soya_chocolate }}</td> @endif
            ...
            @if ($alt_hazelnut_total === 0) @elseif ($delivery->milk_1l_alt_hazelnut === 0) <td></td> @else <td>{{ $delivery->milk_1l_alt_hazelnut }}</td> @endif
        ...
        <tr>
            ...
            @if ($alt_soya_chocolate_total === 0) @else <td>{{ $alt_soya_chocolate_total }}</td> @endif

            @if ($alt_oat_total === 0) @else <td>{{ $alt_oat_total }}</td> @endif
            @if ($alt_cashew_total === 0) @else <td>{{ $alt_cashew_total }}</td> @endif
            @if ($alt_hazelnut_total === 0) @else <td>{{ $alt_hazelnut_total }}</td> @endif
