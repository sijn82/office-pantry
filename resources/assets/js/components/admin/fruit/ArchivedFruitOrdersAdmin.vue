<template>
    ...
    <div id="fruitboxes">
        <h3> Archived Fruit Boxes </h3>

        <div v-if="this.archived_fruitboxes.length"> {{ archived_fruitbox.company_name }}

            <archived-fruitbox class="fruitbox" v-for="archived_fruitbox in this.archived_fruitboxes" :key="archived_fruitbox.id" :archived_fruitbox="archived_fruitbox"></archived-fruitbox>
