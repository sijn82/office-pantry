  ...
  implements FromView, WithEvents, ShouldAutoSize, WithTitle //, WithMultipleSheets
{
    public function view(): View
   {
       ...
       $snackboxes = session()->get('snackbox_APC_unique');
       // dd($snackbox[0][0]);
       
       if ($snackboxes == 'None for this week') {
               
               Log::channel('slack')->info('Snackbox APC Unique Company - None for this week');
