...
class SnackboxUniqueSingleCompanyExportNew implements
WithMultipleSheets
{
        ...
        switch ($this->delivery_days) {
            case 'mon-tue':
                foreach ($mon_tues as $route_day) {
                    $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew($route_day, $this->week_start);
                }
                return $sheets;
                break;
            case 'wed-thur-fri':
                ...
                break;
            case 'mon':
                $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew('Monday', $this->week_start);
                return $sheets;
                break;
            case 'tue':
                $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew('Tuesday', $this->week_start);
                return $sheets;
                break;
            case 'wed':
                $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew('Wednesday', $this->week_start);
                return $sheets;
                break;
            case 'thur':
                $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew('Thursday', $this->week_start);
                return $sheets;
                break;
            case 'fri':
                $sheets[] = new SnackboxUniqueSingleCompanyCollectionExportNew('Friday', $this->week_start);
                return $sheets;
                break;
        }
    }
...
class SnackboxUniqueSingleCompanyCollectionExportNew
      ...
      // dd('got this far...');
       ...
       if (!count($snackboxesGroupedById)) {
          ...
          // dd('This got me where I wanted.');
           ...
           Log::channel('slack')->info('Snackbox OP Unique Singlecompany - None for this week');
