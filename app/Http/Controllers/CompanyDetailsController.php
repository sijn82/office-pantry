...
class CompanyDetailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Contact Details
        $new_company->primary_contact = request('company_details.primary_contact_name');
        ...
        $new_company->secondary_contact = request('company_details.secondary_contact_name');
    ...
    public function update(Request $request, $company_details_id)
    {
        CompanyDetails::where('id', $company_details_id)->update([
            ...
            // Contact Details
            'primary_contact' => request('company_details.primary_contact'),
            ...
            'secondary_contact' => request('company_details.secondary_contact'),
