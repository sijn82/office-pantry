               ...
               while (($data = fgetcsv ($handle,',')) !== FALSE) {
                   ...
                   echo $data[0] . ' is ' . strlen($data[0]) . ' characters long and ' . json_encode($data[1]) . ' is also ' . strlen($data[1]) . '<br>';
                    ...
                    $company_route_name_exceptions =    [
                                                            ...
                                                            'Lloyds (London - 10 Gresham Street – FAO Warren Rose (MLD) / Dawn Sugarman (MLD) / Martyn Shone (Data) / Massir Thomson / Debbie Cattrell (CSD) / Rebecca Wallace / Darren Stratton / Debbie White / Hetvi Patel / Alice Alder / Becky Ball)' => 'Lloyds (London - 10 Gresham Street)',
                                                            'Lloyds (London - 25 Gresham Street - FAO Elaine Charlery)' => 'Lloyds (London - 25 Gresham Street)',
                                                            'Lloyds (London - Old Broad Street - FAO Jamie Mcreesh / Daniel Lee / Parul Patel / Chris Davey (MLD))' => 'Lloyds (London - Old Broad Street)',
