...
class ExportFruitPartnerDeliveries implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $fruitboxes = $this->fruitpartner->fruitbox->where('delivery_week', $this->week_start->current)->where('is_active', 'Active');
        $milkboxes = $this->fruitpartner->milkbox->where('delivery_week', $this->week_start->current)->where('is_active', 'Active');
