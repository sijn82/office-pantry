...
class CreateSnackBoxesTable extends Migration
{
    ...
    public function up() // Migration Updated!
    {
        Schema::create('snack_boxes', function (Blueprint $table) {
            ...
            $table->string('name'); // As we no longer need to create a unique id - a name would be more useful, Twitch Vegan Box etc would help
            ...
            $table->date('invoiced_at')->nullable(); // This is the only thing we still need.
            $table->timestamps();
        });
